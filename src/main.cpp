...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // PawnCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "PawnCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 150 * 20; // Pawncoin: every 20 blocks
static const int64 nTargetSpacing = 150; // Pawncoin: 150 second blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock) {
		...
		if (pindexLast->nHeight > 8020) PastSecondsMin *= 2;
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal pawncoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PawnCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Pawncoin Re-launch";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1395332900;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1865141;
        ...
        assert(block.hashMerkleRoot == uint256("0xf8c3b8e7067f9848771d63fce590e7a7f39da3471e078fcb825a8d71d23fd99e"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // pawncoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
